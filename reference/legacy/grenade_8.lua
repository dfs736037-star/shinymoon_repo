...
l_read_0:label("\a{Link Active}\239\128\135   " .. v89);
...
do
    ...
    v303 = nil;
    v303 = {
        group = ui.create("\a{Link Active}\239\128\147", "\n grenade release", 1)
    };
    v303.enabled = v303.group:switch("\a{Link Active}\239\135\162\aDEFAULT   Grenade Release"):tooltip("Releases the grenade is there's a possibility of dealing damage to an enemy\n\n\aAFAF62FF" .. ui.get_icon("triangle-exclamation") .. "  This feature is a work in progress and may not work as intended");
    v303.group:switch("\a{Link Active}\239\132\155\aDEFAULT  Super Toss", false):set_callback(function(v331)
        -- upvalues: v303 (ref), v85 (ref)
        v303.super_toss = v85(v331);
    end, true);
    ...
    v308.on_visibility = function()
        -- upvalues: v85 (ref), v308 (ref), v271 (ref), l_type_0 (ref), l_find_0 (ref)
        local v346 = v85(v308.selection);
        local v347 = v346 == #v308.selection:list();
        local v348_source = not v347 and v271().locations[v346] or nil;
        local v348_name = v348_source and v348_source.name;
        local v348_default = l_type_0(v348_name) == "string" and l_find_0(v348_name, "Default:", 1, true) == 1;
        ...
        v308.label:visibility(not v347);
        v308.edit:visibility(not v347);
        v308.delete:visibility(not v347 and not v348_default);
    end;
    ...
    do
        ...
        local v399_cached_text = nil;
        local v399_cached_icon = nil;
        local v399_next_update = 0;
        local function v399()
            ...
            if l_l_get_alpha_0_0() == 0 then
                ...
                local v_realtime = l_globals_0.realtime;
                if v_realtime >= v399_next_update or v399_cached_text == nil or v399_cached_icon == nil then
                    local v389 = {};
                    ...
                    for v393 = 1, l_v383_0 do
                        ...
                        local v395 = l_abs_0(l_sin_0(v_realtime % l_pi_0 + v394 * 2));
                    ...
                    v399_cached_text = l_concat_0(v389);
                    v399_cached_icon = v392 .. "\239\135\162";
                    v399_next_update = v_realtime + 0.03;
                end;
                l_l_sidebar_0_0(v399_cached_text, v399_cached_icon);
                return;
            end;
        end;
...
do
    ...
    do
        ...
        local vgh_trace_cursor = 1;
        local vgh_trace_budget = 96;
        local vgh_render_limit = 192;
        l_v519_1 = function(v654, v655, v656)
            ...
            local v657_count = #v654;
            if v657_count > vgh_render_limit then
                local v657_trim = v657_count - vgh_render_limit;
                for v657_index = 1, vgh_render_limit do
                    v654[v657_index] = v654[v657_index + v657_trim];
                end;
                for v657_index = vgh_render_limit + 1, v657_count do
                    v654[v657_index] = nil;
                end;
            end;
            local v657 = v654[#v654];
            v473 = 1;
            v472 = v657;
            if v472 == nil then
                return;
            ...
            if not l_map_patterns_1 then
                ...
                if v665 == 0 then
                    ...
                    if l_v517_1 + 0.07 < l_realtime_0 then
                        ...
                        l_v510_4 = {};
                        v409 = v667;
                        local vgh_trace_start = vgh_trace_cursor;
                        for v668 = 1, v665 do
                            ...
                            if v670 <= 1500 then
                                ...
                                local vgh_trace_offset = (v668 - vgh_trace_start) % v665;
                                if vgh_trace_offset < vgh_trace_budget then
                        ...
                        vgh_trace_cursor = (vgh_trace_start + l_min_0(vgh_trace_budget, v665) - 1) % v665 + 1;
...
do
    ...
    local vgh_text_size_cache_1 = {};
    local vgh_text_size_cache_2 = {};
                ...
                if v472 == nil then
                    ...
                    if l_viewangles_alpha_0 == 0 then
                        ...
                        for v839 = 1, v829 do
                            ...
                            local v853 = vgh_text_size_cache_1[v851];
                            if v853 == nil then
                                v853 = l_measure_text_0(l_v484_2, nil, v851);
                                vgh_text_size_cache_1[v851] = v853;
                            end;
                            local l_v70_0 = v70;
                            if l_description_0 ~= nil then
                                l_description_0 = l_gsub_0(l_upper_0(l_description_0), " ", "  ");
                                local v_desc_size = vgh_text_size_cache_2[l_description_0];
                                if v_desc_size == nil then
                                    v_desc_size = l_measure_text_0(2, nil, l_description_0);
                                    vgh_text_size_cache_2[l_description_0] = v_desc_size;
                                end;
                                l_v70_0 = v_desc_size;
                            end;
...
do
    ...
    l_v479_1 = {
        Frag = function(v875)
            ...
            if l_hegrenade_0 > 0 and (l_hegrenade_0 == 51 and l_fatal_0 or l_hegrenade_0 ~= 51 and l_hegrenade_0 <= l_damage_0 or l_fatal_0) then
                local v879 = globals.tickcount or 0;
        ...
        Flash = function(v880)
            ...
            if l_flashbang_0 > 0 and l_flashbang_0 <= l_damage_1 then
                local v883 = globals.tickcount or 0;
                l_v477_2 = l_camera_angles_0();
                l_v476_2 = v883;
            end;
        end, 
        Molly = function(v884)
            ...
            if l_molotov_0 > 0 and v887 > 0 and v887 <= l_molotov_0 then
                local v888 = globals.tickcount or 0;
                l_v477_2 = l_camera_angles_0();
                l_v476_2 = v888;
            end;
        end
    ...
    do
        ...
        l_v478_2 = function(v890)
            ...
            local v891_tickcount = globals.tickcount or 0;
            if l_v476_2 ~= nil and l_v476_2 ~= v891_tickcount then
                l_v477_2 = nil;
                l_v476_2 = nil;
            end;
            local v891 = l_l_v479_1_0[v890.type];
            if v891 ~= nil then
                v891(v890);
            end;
            return true;
    ...
    do
        ...
        local l_release_lock_until_0 = 0;
        local l_release_hold_until_0 = 0;
        local l_release_angles_0 = nil;
        local l_release_weapon_0 = nil;
        local l_release_buttons_0 = {
            attack = false,
            attack2 = false
        };
        l_v479_1 = function(v895)
            ...
            local v896 = l_customization_0.super_toss == true;
            local v896_tickcount = globals.tickcount or 0;
            local v897 = l_v476_2 ~= nil and l_v477_2 ~= nil and v896_tickcount - l_v476_2 >= 0 and v896_tickcount - l_v476_2 <= 2 and v85(l_customization_0.enabled);
            if v85(l_v482_2) then
                return;
            elseif not v896 and not v897 then
                return;
            else
                local v898 = l_get_local_player_0();
                if v898 == nil or not v898:is_alive() then
                    return;
                elseif not (l_band_0(v898.m_fFlags, l_l_v480_2_0) ~= 0 and not v895.in_jump) and l_customization_0.disable_in_air then
                    return;
                else
                    local v899 = v898:get_player_weapon();
                    local v899_weapon_index = v899 and v899:get_weapon_index();
                    local v899_tickcount = globals.tickcount or 0;
                    if v899 == nil then
                        return;
                    elseif l_v481_2[v899_weapon_index] == nil then
                        return;
                    else
                        if v897 then
                            if l_release_lock_until_0 <= v899_tickcount or l_release_weapon_0 ~= v899_weapon_index or l_release_angles_0 == nil then
                                l_release_buttons_0.attack = v895.in_attack or false;
                                l_release_buttons_0.attack2 = v895.in_attack2 or false;
                                if not l_release_buttons_0.attack and not l_release_buttons_0.attack2 then
                                    l_release_buttons_0.attack = true;
                                end;
                                l_release_hold_until_0 = v899_tickcount + 2;
                            end;
                            l_release_angles_0 = {
                                x = l_v477_2.x, 
                                y = l_v477_2.y
                            };
                            l_release_weapon_0 = v899_weapon_index;
                            l_release_lock_until_0 = v899_tickcount + 16;
                        elseif l_release_lock_until_0 > 0 and v899_tickcount > l_release_lock_until_0 then
                            l_release_lock_until_0 = 0;
                            l_release_hold_until_0 = 0;
                            l_release_angles_0 = nil;
                            l_release_weapon_0 = nil;
                            l_release_buttons_0.attack = false;
                            l_release_buttons_0.attack2 = false;
                        end;
                        local v899_release_locked = v85(l_customization_0.enabled) and l_release_lock_until_0 > v899_tickcount and l_release_weapon_0 == v899_weapon_index and l_release_angles_0 ~= nil;
                        local v899_release_active = v897 or v899_release_locked;
                        local l_view_angles_0 = v895.view_angles;
                        local l_view_angles_1 = v895.view_angles;
                        if v899_release_active and l_release_angles_0 ~= nil then
                            local l_x_4 = l_release_angles_0.x;
                            l_view_angles_1.y = l_release_angles_0.y;
                            l_view_angles_0.x = l_x_4;
                        end;
                        if v896 and (v899.m_bPinPulled or v899.m_fThrowTime > 0 or v897) then
                            local l_weapon_info_0 = v899:get_weapon_info();
                            local l_throw_strength_0 = v899.m_flThrowStrength;
                            if l_weapon_info_0 ~= nil and l_throw_strength_0 ~= nil then
                                local v900 = (l_throw_strength_0 * 0.7 + 0.3) * l_clamp_0(l_weapon_info_0.throw_velocity * 0.9, 15, 750);
                                local l_velocity_0 = v898.m_vecVelocity;
                                if l_velocity_0 ~= nil and v900 > 0 then
                                    local v901 = l_vector_0():angles(l_vector_0(l_view_angles_0.x, l_view_angles_0.y));
                                    local v902 = l_velocity_0:length();
                                    if v902 > 0 then
                                        local v903 = v901:dot(-l_velocity_0:normalized());
                                        local v904 = 25 * v903 * v903 * v902 * v902 + 16 * v900 * v900 - 25 * v902 * v902;
                                        if v904 >= 0 then
                                            local v905 = ((math.sqrt(v904) - 5 * v902 * v903) * 0.25 * v901 - l_velocity_0 * 1.25) * (1 / v900);
                                            if not (v905.x ~= v905.x or v905.y ~= v905.y or v905.z ~= v905.z) then
                                                if v905.y == 0 and v905.x == 0 then
                                                    l_view_angles_0.x = v905.z <= 0 and 90 or 270;
                                                else
                                                    local v906 = v905:angles();
                                                    l_view_angles_0.x = v906.x;
                                                    l_view_angles_1.y = v906.y;
                                                end;
                                            end;
                                        end;
                                    end;
                        ...
                        if v899_release_active and (v899.m_bPinPulled or v899.m_fThrowTime > 0) then
                            if v899_tickcount <= l_release_hold_until_0 and v899.m_fThrowTime == 0 then
                                v895.in_attack = l_release_buttons_0.attack;
                                v895.in_attack2 = l_release_buttons_0.attack2;
                            else
                                v895.in_attack2 = false;
                                v895.in_attack = false;
                            end;
                        elseif v899_release_active then
                            l_release_lock_until_0 = 0;
                            l_release_hold_until_0 = 0;
                            l_release_angles_0 = nil;
                            l_release_weapon_0 = nil;
    ...
    v481 = function()
        ...
        l_events_0.createmove(l_v479_1, true);
    end;
...
do
    ...
    (function()
        ...
        local l_default_locations_finished_0 = false;
        local function l_commit_default_locations_0()
            if l_default_locations_finished_0 or v1056 == nil or l_locations_7 == nil then
                return;
            end;
            l_default_locations_finished_0 = true;
            for v_default_index = 1, #v1054 do
                if l_locations_7[v_default_index] == nil then
                    l_locations_7[v_default_index] = {
                        name = v1054[v_default_index][2], 
                        locations = {}, 
        ...
        local v_default_locations_complete = #l_locations_7 >= #v1054;
        if v_default_locations_complete then
            for v_default_index = 1, #v1054 do
                local v_default_location = l_locations_7[v_default_index];
                if v_default_location == nil or v_default_location.download_pending then
                    v_default_locations_complete = false;
                    break
                end;
            end;
        end;
        if v_default_locations_complete then
                ...
                do
                    ...
                    do
                        ...
                        l_get_1(v1062, nil, function(v1065)
                            -- upvalues: v1056 (ref), l_locations_7 (ref), l_default_locations_finished_0 (ref), l_pcall_0 (ref), l_parse_0 (ref), l_type_0 (ref), l_v1058_0 (ref), l_v1061_0 (ref), v1055 (ref), v1054 (ref), l_commit_default_locations_0 (ref)
                            if l_default_locations_finished_0 or v1056 == nil or l_locations_7 == nil then
                                return;
                            end;
                            if l_type_0(v1065) == "string" and #v1065 > 0 then
                                local v1066, v1067 = l_pcall_0(l_parse_0, v1065);
                                if v1066 and l_type_0(v1067) == "table" then
            ...
            l_execute_after_0(5, l_commit_default_locations_0);
            return;
        end;
    end)();
    v484 = nil;
        ...
        local function v1133()
            ...
            if l_v487_6 == nil then
                ...
                for v1112 = 1, #l_v487_6 do
                    ...
                    local v1115_text = l_select_0(v1114 and 6 or 5, l_unpack_0(v1113));
                    local v1115_key = (v1114 and "i|" or "t|") .. v1115_text;
                    local v1115 = v1133_text_size_cache[v1115_key];
                    if v1115 == nil then
                        v1115 = l_measure_text_0(1, nil, v1115_text);
                        v1133_text_size_cache[v1115_key] = v1115;
                    end;
                    local l_x_5 = v1115.x;
                    local l_y_3 = v1115.y;
                    if v1114 then
    ...
    do
        ...
        l_v489_3 = function(v1137)
            ...
            if l_decode_0 and l_decode_0.locations and l_decode_0.locations.enabled then
                v86(l_decode_0.locations.enabled, v439.enabled);
            end;
        ...
        l_l_v490_2_2:set_callback(function()
            if l_v489_3 then
                l_v489_3();
            end;
        end, true);
    ...
    do
        ...
        l_sv_cheats_0 = function()
            ...
            if v439 == nil then
                ...
                if l_location_9 == nil or l_location_9.editing == nil or l_location_9.original == nil then
                    return;
                end;
                local l_index_1 = l_location_9.index;
                local l_editing_2 = l_location_9.editing;
                local l_original_0 = l_location_9.original;
                if l_index_1 == 0 and l_editing_2.position == nil and l_editing_2.viewangles == nil and l_editing_2.weapon == nil then
                    l_v487_6 = nil;
                    v1164 = nil;
                    return;
                end;
                ...
                if l_index_1 == 0 and (l_editing_2.position == nil or l_editing_2.viewangles == nil or l_editing_2.weapon == nil) then
                    v1181 = false;
                end;
                if l_original_0.position == nil and l_original_0.viewangles == nil and l_original_0.weapon == nil then
                    v1181 = false;
                end;
                ...
                if l_get_4(l_builder_2.type) ~= "Movement" then
                    ...
                    if v1227 == nil or not v1227:is_alive() then
                        ...
                        if not l_get_4(l_builder_2.record) then
                            ...
                            if l_v487_6 == nil or v1164 == nil then
                                l_sv_cheats_0();
                            end;
                            l_v487_6[v1164] = {
                                234, 
    ...
    do
        ...
        l_builder_1 = function()
            ...
            if v439 == nil then
                ...
                if v1250 == nil or v1250.is_new then
    ...
    do
        ...
        v1287 = function()
            ...
            if not v1330 or v1330.is_new then
                return;
            end;
